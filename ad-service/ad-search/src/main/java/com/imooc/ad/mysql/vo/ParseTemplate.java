...
public class ParseTemplate {
    ...
    public static ParseTemplate parse(Template _template) {
        ...
        for (JsonTable table : _template.getTableList()) {
            ...
            final Integer level = table.getLevel();

            final TableTemplate tableTemplate = new TableTemplate();
            ...
            // 遍历操作类型对应的列
            final Map<OpType, List<String>> opTypeFieldSetMap = tableTemplate.getOpTypeFieldSetMap();
